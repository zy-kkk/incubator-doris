...
suite("test_mysql_all_types_ctas", "p0,external,mysql,external_docker,external_docker_mysql") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        ...
        sql """create table all_types_nullable properties("replication_num" = "1") as select * from mysql_all_type_tvf_test.doris_test.all_types_nullable;"""

        qt_select_all_types_nullable """select * from internal.test_mysql_all_types_ctas.all_types_nullable order by 1;"""

        sql """create table all_types_non_nullable properties("replication_num" = "1") as select * from mysql_all_type_tvf_test.doris_test.all_types_non_nullable;"""

        qt_select_all_types_non_nullable """select * from internal.test_mysql_all_types_ctas.all_types_non_nullable order by 1;"""

        sql """create table t_varchar properties("replication_num" = "1") as select * from mysql_all_type_tvf_test.doris_test.t_varchar;"""

        qt_select_varchar """select * from internal.test_mysql_all_types_ctas.t_varchar order by 1;"""

        sql """create table t_char properties("replication_num" = "1") as select * from mysql_all_type_tvf_test.doris_test.t_char;"""
