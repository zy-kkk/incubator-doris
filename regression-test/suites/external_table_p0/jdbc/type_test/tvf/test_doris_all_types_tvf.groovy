...
suite("test_doris_all_types_tvf", "p0,external,doris,external_docker,external_docker_doris") {
    ...
    sql """create database if not exists test_doris_all_types_tvf;"""

    sql """use internal.test_doris_all_types_tvf;"""
    ...
    sql """ CREATE CATALOG doris_all_type_tvf_test PROPERTIES (
        "user" = "${jdbcUser}",
        "type" = "jdbc",
    ...
    qt_desc_tvf_all_types_null """desc function query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.all_types_nullable');"""
    qt_tvf_null_all_types_null """select * from query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.all_types_nullable') order by 1;"""

    qt_desc_tvf_bitmap_hll_types """desc function query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.t_hll_bitmap');"""
    qt_tvf_bitmap_hll_types """select * from query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.t_hll_bitmap') order by 1;"""

    qt_desc_tvf_arr_types """desc function query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.arr_types_test');"""
    qt_tvf_arr_types """select * from query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.arr_types_test') order by 1;"""

    qt_desc_tvf_arr_nesting_types """desc function query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.arr_nesting_types_test');"""
    qt_tvf_arr_nesting_types """select * from query('catalog' = 'doris_all_type_tvf_test', 'query' = 'select * from test_doris_all_types_tvf.arr_nesting_types_test') order by 1;"""

    sql """drop database if exists test_doris_all_types_tvf;"""
    sql """drop catalog if exists doris_all_type_tvf_test """
