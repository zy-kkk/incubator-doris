...
void register_function_array_split(LambdaFunctionFactory& factory);
void register_function_reverse_array_split(LambdaFunctionFactory& factory);
...
public:
    static LambdaFunctionFactory& instance() {
        ...
        std::call_once(oc, []() {
            ...
            register_function_array_split(instance);
            register_function_reverse_array_split(instance);
        });
        return instance;
    }
};
