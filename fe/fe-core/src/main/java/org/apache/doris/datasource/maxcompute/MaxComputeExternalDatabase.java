...
public class MaxComputeExternalDatabase extends ExternalDatabase<MaxComputeExternalTable> {
    ...
    @Override
    public MaxComputeExternalTable buildTableForInit(String tableName, long tblId, ExternalCatalog catalog,
            ExternalDatabase db) {
        return new MaxComputeExternalTable(tblId, tableName, tableName, (MaxComputeExternalCatalog) extCatalog,
