...
public class TestExternalDatabase extends ExternalDatabase<TestExternalTable> {
    ...
    @Override
    public TestExternalTable buildTableForInit(String tableName, long tblId, ExternalCatalog catalog,
            ExternalDatabase db) {
        return new TestExternalTable(tblId, tableName, tableName, (TestExternalCatalog) extCatalog,
