...
public class IcebergExternalDatabase extends ExternalDatabase<IcebergExternalTable> {
    ...
    @Override
    public IcebergExternalTable buildTableForInit(String tableName, long tblId, ExternalCatalog catalog,
            ExternalDatabase db) {
        return new IcebergExternalTable(tblId, tableName, tableName, (IcebergExternalCatalog) extCatalog,
